    ...
    def _builtin_integrations(self) -> List[Dict]:
        return [
            ...
            },
            {
                ...
                "description": "Calls Google Drive REST API with OAuth bearer token.",
                "required_fields": ["api_key", "url"],
                "handler": "google_drive_api",
                "source": "Built-in",
                "category": "Google",
                "auth_type": "oauth_bearer",
            },
            {
                "key": "dropbox_api",
                "name": "Dropbox API",
                "description": "Calls Dropbox HTTP API with bearer token.",
                "required_fields": ["api_key", "url"],
                "handler": "dropbox_api",
                "source": "Built-in",
                "category": "Storage",
            ...
            },
            {
                "key": "shopify_api",
                "name": "Shopify API",
                "description": "Calls Shopify Admin API endpoints.",
                "required_fields": ["api_key", "url"],
                "handler": "shopify_api",
                "source": "Built-in",
                "category": "Commerce",
            ...
            },
            {
                "key": "webflow_api",
                "name": "Webflow API",
                "description": "Calls Webflow Data API endpoints.",
                "required_fields": ["api_key", "url"],
                "handler": "webflow_api",
                "source": "Built-in",
                "category": "Marketing",
            ...
            },
            {
                "key": "supabase_api",
                "name": "Supabase API",
                "description": "Calls Supabase REST endpoints for tables/functions.",
                "required_fields": ["api_key", "url"],
                "handler": "supabase_api",
                "source": "Built-in",
                "category": "Data",
                "auth_type": "api_key",
            },
            {
                "key": "openrouter_api",
                "name": "OpenRouter API",
                "description": "Calls OpenRouter chat/completions or model endpoints.",
                "required_fields": ["api_key", "url"],
