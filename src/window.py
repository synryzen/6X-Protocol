...
class MainWindow(Adw.ApplicationWindow):
    ...
    NAV_ITEMS = [
        ...
        ("runs", "Runs", "view-list-symbolic"),
        ("integrations", "Integrations", "network-server-symbolic"),
    ...
    def get_canvas_palette_commands(self) -> list[dict]:
        return [
            ...
            {
                "title": "Canvas: Run Active Workflow",
                "subtitle": "Start execution for the workflow selected in Canvas.",
                "icon": "media-playback-start-symbolic",
                "shortcut": "",
                "keywords": "canvas run execute active workflow",
                "handler": lambda: self.canvas_view.on_run_active_workflow(None),
            },
            {
                "title": "Canvas: Cancel Active Run",
                "subtitle": "Request stop for the latest running canvas workflow run.",
                "icon": "media-playback-stop-symbolic",
                "shortcut": "",
                "keywords": "canvas cancel stop run",
                "handler": lambda: self.canvas_view.on_cancel_latest_workflow_run(None),
            },
            {
                "title": "Canvas: Retry Failed Node",
                "subtitle": "Retry from the failed node on the latest failed run.",
                "icon": "view-refresh-symbolic",
                "shortcut": "",
                "keywords": "canvas retry failed node run",
                "handler": lambda: self.canvas_view.on_retry_latest_failed_node(None),
            },
            {
                "title": "Canvas: Approve Waiting Run",
                "subtitle": "Approve and resume latest run waiting for approval.",
                "icon": "emblem-ok-symbolic",
                "shortcut": "",
                "keywords": "canvas approve resume run",
                "handler": lambda: self.canvas_view.on_resume_latest_approval(None),
            },
            {
