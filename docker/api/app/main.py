...
INTEGRATION_CATALOG: list[dict[str, Any]] = [
    ...
    {"key": "handoff", "name": "Bot Handoff", "category": "ai", "required_fields": ["bot_chain"]},
    ...
    {"key": "google_calendar_api", "name": "Google Calendar API", "category": "google", "required_fields": ["api_key", "url"]},
    ...
    {"key": "linear_api", "name": "Linear API", "category": "developer", "required_fields": ["api_key"]},
    {"key": "google_drive_api", "name": "Google Drive API", "category": "google", "required_fields": ["api_key", "url"]},
    {"key": "dropbox_api", "name": "Dropbox API", "category": "storage", "required_fields": ["api_key", "url"]},
    ...
    {"key": "shopify_api", "name": "Shopify API", "category": "commerce", "required_fields": ["api_key", "url"]},
    {"key": "webflow_api", "name": "Webflow API", "category": "marketing", "required_fields": ["api_key", "url"]},
    {"key": "supabase_api", "name": "Supabase API", "category": "data", "required_fields": ["api_key", "url"]},
    {"key": "openrouter_api", "name": "OpenRouter API", "category": "ai", "required_fields": ["api_key", "url"]},
    {"key": "resend_email", "name": "Resend Email", "category": "communication", "required_fields": ["api_key", "from", "to", "subject"]},
    {"key": "mailgun_email", "name": "Mailgun Email", "category": "communication", "required_fields": ["api_key", "domain", "from", "to", "subject"]},
    ...
    {"key": "file_append", "name": "File Append", "category": "system", "required_fields": ["path"]},
...
def meta() -> dict[str, str]:
    ...
    return {
        ...
        "secret_provider_envfile_loaded": "true"
        if bool(getattr(secret_resolver, "env_file_loaded", False))
        else "false",
...
def get_secret_provider() -> dict[str, str]:
    ...
    return {
        ...
        "envfile_loaded": "true" if bool(getattr(resolver, "env_file_loaded", False)) else "false",
        ...
        "env_file_path": str(getattr(resolver, "env_file_path", "") or ""),
