...
- [x] Relational migration scaffold expansion (Postgres revision tracking + `r0001-r0006` schema baseline)
...
2. Continue feature-flagged Postgres repository cutover using `r0001-r0006` schema baseline for workflows/runs/settings/integrations/bots.
