# 6X-Protocol Studio v0.1.7 Announcement Kit (Technical)
...
```md
6X-Protocol Studio v0.1.7 is out.
...
```text
6X-Protocol Studio v0.1.7 shipped.
...
```text
I released 6X-Protocol Studio v0.1.7 (open source).
