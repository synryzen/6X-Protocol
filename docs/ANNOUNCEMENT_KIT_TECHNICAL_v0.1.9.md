# 6X-Protocol Studio v0.1.9 Announcement Kit (Technical)
...
```md
6X-Protocol Studio v0.1.9 is out.
...
Release: https://github.com/synryzen/6X-Protocol/releases/tag/v0.1.9
...
```text
6X-Protocol Studio v0.1.9 shipped.
...
```text
I released 6X-Protocol Studio v0.1.9 (open source).
